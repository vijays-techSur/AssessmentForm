...
# Project dev script: `next dev -H 0.0.0.0 -p 4000` (from package.json .scripts.dev)
# Uses project's own dev command which already sets 0.0.0.0 binding and port 4000.
